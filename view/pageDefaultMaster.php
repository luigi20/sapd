     ...
     <div class="container-fluid">
        <div class="row">
                ...
                <ul class="list-unstyled">
                    <li class="nav-header">
                        ...
                        <ul class="list-unstyled collapse in" id="userMenu">
                            ...
                            <li class="active"><a href=""><i class="glyphicon glyphicon-folder-open"></i> </a></li>
                    ...
                    <li class="nav-header">
                        ...
                        <ul class="list-unstyled collapse in" id="Ul1">
                            ...
                            <li><a href=""><i class="glyphicon glyphicon-user"></i> Professor</a></li>
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Home</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">

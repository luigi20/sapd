...
<body>
    <form action="/sapd/lesson/addclasslesson" method="post">
		<?php
							   ...
							   <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select name = "iLocal" autocomplete = "off" class="form-control">
											<?php
												...
												{
											?>		
											 <option value= '<?=  $aLocal['idLugar'] ?>'><?=  $aLocal['nomeLugar'] ?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-2">
                                    <label>
                                        Data</label>
                                    <div class="controls">
										<input type="text" name ="sDateClassLesson" autocomplete = "off" maxlength= "10" required class="form-control" id="dateClassLesson" onKeyUp="formataData(dateClassLesson,event)"/> <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-2">
                                    ...
                                    <div class="controls">
                                         <input type="time"  autocomplete = "off"  name = "sStartingTime" required class="form-control" id="startingTime" />
                                ...
                                <div class="control-group col-md-2">
                                    <label>
                                        Horario Final</label>
                                    <div class="controls">
                                        <input type="time"  autocomplete = "off"  name = "sFinalTime" required class="form-control" id="finalTime" />
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                      <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off"  name ="sLessonDescription" > </textarea>

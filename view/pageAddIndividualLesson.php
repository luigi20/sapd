...
<body>
    <form action="/sapd/lesson/addindividuallesson" method="post">
		<?php
                                    ...
                                    <div class="controls">
                                        <select name = "iStudent" autocomplete = "off" class="form-control">
											<?php
												...
												{
											?>		
											 <option value= '<?=  $aUserStudents['idAluno'] ?>'><?=  $aUserStudents['nomeAluno'] ?></option>
											<?php
												}
											?>
							  ...
							  <div class="control-group col-md-3">
                                ...
                                <div class="control-group col-md-3">
                                    <label>
                                        Data</label>
                                    <div class="controls">
										<input type="text" name ="sDateIndividualLesson" autocomplete = "off" maxlength= "10" required class="form-control" id="dateIndividualLesson" onKeyUp="formataData(dateIndividualLesson,event)"/> <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-3">
                                    ...
                                    <div class="controls">
                                         <input type="time"  autocomplete = "off"  name = "sStartTimeIndividualLesson" required class="form-control" />
                                ...
                                <div class="control-group col-md-3">
                                    <label>
                                        Horario Final</label>
                                    <div class="controls">
                                        <input type="time"  autocomplete = "off"  name = "sFinalTimeIndividualLesson" required class="form-control" />
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                      <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off"  name ="sDescriptionIndividualLesson" > </textarea>

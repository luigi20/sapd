...
<body>
    <form action="/sapd/payment/updatepayment" method="post">
		<?php
			$aAllUserStudents = Student::allUserPaymentStudent();
			$aPayment = Payment::findEditPayment();
		?>
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Pagamento</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-7">
                                    <label>
                                        Aluno</label>
                                    <div class="controls">
										<select name = "iStudentId"  class="form-control">
											<?php
												foreach($aAllUserStudents as $oUserStudents)
												{
											?>		
											  <option  <?php echo $oUserStudents['idAluno'] == $aPayment['Aluno_idAluno'] ? 'selected':'';?> value="<?= $oUserStudents['idAluno']?>"> <?= $oUserStudents['nomeAluno']?></option>
											<?php
												}
											?>
										</select>
                                 ...
                                 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sPaymentDay" autocomplete = "off" value="<?=$aPayment['dataPagamento']?>" class="form-control" maxlength="10" id= "paymentDay" onKeyUp="formataData(paymentDay,event)" required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    <label>
                                        Mes e Ano de Pagamento </label>
                                    <div class="controls">
                                        <input type="month" name ="iPaymentMonth"  value="<?=$aPayment['anoPagamento'].'-'.$aPayment['mesPagamento']?>"  autocomplete = "off" class="form-control" maxlength="14" min="2017-01-01" max="2099-12-31" id= "paymentMonth"  required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sPaymentLocal" autocomplete = "off" value="<?=$aPayment['localPagamento']?>"  class="form-control"   required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    <label>
                                        Valor de Pagamento </label>
                                    <div class="controls">
                                        <input type="text" name ="iPaymentValue" autocomplete = "off" value="<?=$aPayment['valorPagamento']?>"  class="form-control" maxlength="4" id= "paymentValue" onKeyUp="formataInteiro(paymentValue,event)" required/>
                                        <br />
                                    </div>
                                </div>
								</br>

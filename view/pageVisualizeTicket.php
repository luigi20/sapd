...
<body>
    <form action="/sapd/login/pagevisualizeticketevent" method="post">
		<?php
			$aAllEventTicket = Ticket::allTicketEvent();
		?>
    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">Ingresso</th>
			</tr>
			...
			<tr>
				...
				<td  align="center">Qtd Vendida</td>
				<td  align="center">Lucro(R$)</td>
			...
			<tr>
				<?php
				    ...
				    if(!empty($aAllEventTicket))
				    {
						foreach ($aAllEventTicket as $aTicket) 
						{	
							$aEvent = Event::findEvent($aTicket['Evento_idEvento']);
				?>	
							<tr>
								<td align="center"> <?= $aTicket['idIngresso'];?> </td>
								<td align="center"> <?= $aEvent['nomeEvento'];?> </td>
								<td align="center"> <?= $aTicket['nomeIngresso'];?> </td>
								<td align="center"> <?= $aTicket['valorIngresso'];?> </td>
								<td align="center"> <?= $aTicket['qtdVendIngresso'];?> </td>
								<td align="center"> <?= $aTicket['lucroIngresso'];?> </td>
								<td align="center"> <a href="/sapd/ticket/editticket/<?= $aTicket['idIngresso']?>">Editar  </a>
								<a  href="/sapd/ticket/removeticket/<?= $aTicket['idIngresso'] ?> ">Deletar</a> </td>
								</td>
							</tr>
				<?php
						}
		 ...
		 <div class="controls">
            <div class="control-group col-md-12">
				<div class="controls">
					<input type="submit" name = "btnAdd" class="btn btn-primary" value="<- Voltar"/>

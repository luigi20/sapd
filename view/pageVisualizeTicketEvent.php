    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title">
                                    ...
                                    <h4 id="head_pagina">
                                        GERENCIAR INGRESSOS DO EVENTO</h4>
                                </div>
                            </div>
			...
			<tr>
				<th colspan="10" align="center">EVENTO</th>
			</tr>
			...
			<tr>
				...
				<td  align="center">Renda(R$)</td>
				<td  align="center">Custo(R$)</td>
			...
			<tr>
				<?php
				    ...
				    if(!empty($aAllEvent))
				    {
						foreach ($aAllEvent as $aEvent) 
						{	
				?>	
							<tr>
								<td align="center"> <?= $aEvent['idEvento'];?> </td>
								<td align="center"> <?= $aEvent['nomeEvento'];?> </td>
								<td align="center"> <?= $aEvent['enderecoEvento'];?> </td>
								<td align="center"> <?= $aEvent['rendaEvento'];?> </td>
								<td align="center"> <?= $aEvent['custoEvento'];?> </td>
								<td align="center"> <?= $aEvent['lucroEvento'];?> </td>
								<td align="center"> <a href="/sapd/event/visualizeticket/<?= $aEvent['idEvento']?>">Visualizar Ingressos </a>
								</td>
							</tr>
				<?php
						}

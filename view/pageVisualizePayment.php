...
<body>
    <form action="" method="post">
		<?php
			$aAllPayment = Payment:: allUserPayment();
		?>
    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">PAGAMENTO</th>
			</tr>
			...
			<tr>
				<?php
				    ...
				    if(!empty($aAllPayment))
				    {
						foreach ($aAllPayment as $aPayment) 
						{	
							$aStudent = Student::findStudent($aPayment['Aluno_idAluno']);
				?>	
							<tr>
								<td align="center"> <?= $aPayment['idPagamento'];?> </td>
								<td align="center"> <?= $aStudent['nomeAluno'];?> </td>
								<td align="center"> <?= $aPayment['dataPagamento'];?> </td>
								<td align="center"> <?= $aPayment['mesPagamento'];?> </td>
								<td align="center"> <?= $aPayment['localPagamento'];?> </td>
								<td align="center"> <?= $aPayment['valorPagamento'];?> </td>
								<td align="center"> <?= $aPayment['anoPagamento'];?> </td>
								<td align="center"> <a href="/sapd/payment/editpayment/<?= $aPayment['idPagamento']?>">Editar  </a>
								<a  href="/sapd/payment/removepayment/<?= $aPayment['idPagamento'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					

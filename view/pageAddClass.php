...
<body>
    <form action="/sapd/studentsclass/addclass" method="post">
		<?php
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="controls">
                                        <select  name = "iLocalId" autocomplete = "off" class="form-control">
											<?php
												...
												{
											?>		
											 <option value= '<?=  $oLocal['idLugar'] ?>'><?=  $oLocal['nomeLugar'] ?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        Nome da Turma </label>
                                    <div class="controls">
                                        <input type="text" name ="sClassName" autocomplete = "off" required class="form-control"/>
                                        <br />
                                    </div>
                                </div>
                                <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                      <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off"  name ="sClassRitAndInfo" > </textarea>

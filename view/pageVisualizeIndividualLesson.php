...
<body>
    <form action="" method="post">
		<?php
			$aAllIndividualLesson = IndividualLesson::allUserIndividualLesson();
		?>
    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">AULA INDIVIDUAL</th>
			</tr>
			...
			<tr>
				...
				<td  align="center">Tipo de Aula </td>
			...
			<tr>
				<?php
				    ...
				    if(!empty($aAllIndividualLesson))
				    {
						foreach ($aAllIndividualLesson as $aIndividualLesson) 
						{	
							$aStudent = Student::findStudent($aIndividualLesson['Aluno_idAluno']);
				?>	
							<tr>
								<td align="center"> <?= $aIndividualLesson['idAulaIndividual'];?> </td>
								<td align="center"> <?= $aStudent['nomeAluno'];?> </td>
								<td align="center"> <?= $aIndividualLesson['dataAulaIndividual'];?> </td>
								<td align="center"> <?= $aIndividualLesson['horarioInicioAulaIndividual'];?> </td>
								<td align="center"> <?= $aIndividualLesson['horarioTerminoAulaIndividual'];?> </td>
								<td align="center"> <?= $aIndividualLesson['tipoAulaIndividual'];?> </td>
								<td align="center"> <a href="/sapd/lesson/editindividuallesson/<?= $aIndividualLesson['idAulaIndividual']?>">Editar  </a>
								<a  href="/sapd/lesson/removeindividuallesson/<?= $aIndividualLesson['idAulaIndividual'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					

    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">LOCAL</th>
			</tr>
			...
			<tr>
				...
				?>	
							<tr>
								<td align="center"> <?= $aLocal['idLugar'];?> </td>
								<td align="center"> <?= $aLocal['nomeLugar'];?> </td>
								<td align="center"> <?= $aLocal['enderecoLugar'];?> </td>
								<td align="center"> <?= $aLocal['telLugar'];?> </td>
								<td align="center"> <a href="/sapd/local/editlocal/<?= $aLocal['idLugar']?>">Editar  </a>
								<a  href="/sapd/local/removelocal/<?= $aLocal['idLugar'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					

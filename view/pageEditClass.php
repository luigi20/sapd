...
<body>
    <form action="/sapd/studentsclass/updateclass" method="post">
		<?php
			$aClass	 = StudentsClass::findEditClass(); 
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Turma</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-6">
                                    <label>
                                        ...
                                        Lugar</label>
                                    <div class="controls">
                                        <select  name = "iLocalId" autocomplete = "off" class="form-control">
											<?php
												foreach($aAllLocal as $oLocal)
												{
											?>		
											 <option  <?php echo $aClass['Lugar_idLugar'] == $oLocal['idLugar'] ? 'selected':'';?> value="<?= $oLocal['idLugar']?>"> <?= $oLocal['nomeLugar']?></option>
											<?php
												}
											?>
                                ...
                                <div class="control-group col-md-6">
                                    <label>
                                        Nome da Turma </label>
                                    <div class="controls">
                                        <input type="text" name ="sClassName" autocomplete = "off" required class="form-control" value= "<?=$aClass['nomeTurma']?>"/>
                                        <br />
                                    </div>
                                </div>
                                <div class="control-group col-md-6">
                                    <label>
                                        Ritmos Ensinados e Outras Informações</label>
                                    <div class="controls">
                                      <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off"  name ="sClassRitAndInfo"  ><?=$aClass['obsTurma']?> </textarea>

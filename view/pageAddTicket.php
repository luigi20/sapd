...
<body>
    <form action="/sapd/ticket/addticket" method="post">
		<?php
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-4">
                                    <label>
                                       Nome</label>
                                    <div class="controls">
										<input type="text" name ="sTicketName" autocomplete = "off" required class="form-control"/>
                                    </div>
                                </div>
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
										<select name = "iIdEvent" autocomplete = "off" class="form-control">
											<?php
												...
												{
											?>		
											 <option value= '<?=  $aUserEvent['idEvento'] ?>'><?=  $aUserEvent['nomeEvento'] ?></option>
											<?php
												}
											?>
                                 ...
                                 <div class="control-group col-md-6">
                                    <label>
                                        Valor(R$) </label>
                                    <div class="controls">
                                       <input type="text" name ="fTicketValue" id = "ticketValue"  onKeyUp="formataInteiro(ticketValue,event)" onBlur = "calcularIngresso();" autocomplete = "off" required class="form-control"/>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                       <input type="text" autocomplete ="off" required="required" value = "0" name="fTicketQtd" id= "ticketQtd"  onBlur = "calcularIngresso();" onKeyUp="formataInteiro(ticketQtd,event)" class="form-control"/>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-4">
                                    <label>
                                        Lucro(R$) </label>
                                    <div class="controls">
                                       <input type="tel" readonly autocomplete ="off" required="required" name="fTicketProfit" id= "ticketProfit"  class="form-control"/>
                                        <br />
                                    </div>
                                </div>
								</br>

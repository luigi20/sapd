...
<body>
    <form action="/sapd/local/updatelocal" method="post">
		<?php
			$oLocal	 = Local::findEditLocal(); 
		?>
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Lugar</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-4">
                                    <label>
                                       Nome</label>
                                    <div class="controls">
										<input type="text" name ="sLocalName" autocomplete = "off" required class="form-control" value="<?=$oLocal['nomeLugar']?>"/>
                                    </div>
                                </div>
                                 <div class="control-group col-md-6">
                                    <label>
                                        Endereco </label>
                                    <div class="controls">
                                       <input type="text" name ="sLocalAddress" autocomplete = "off" required class="form-control" value="<?=$oLocal['enderecoLugar']?>"/>
                                        <br />
                                    </div>
                                </div>
								...
								<div class="control-group col-md-4">
                                    <label>
                                        Telefone </label>
                                    <div class="controls">
                                        <input type="tel" autocomplete ="off" required="required" maxlength="14" name="iLocalTel" value ="<?=$oLocal['telLugar']?>" id= "telefone" pattern="\([0-9]{2}\) [0-9]{4,6}-[0-9]{3,4}$" onKeyUp = "formataTelefone(telefone,event)" class="form-control"/>
                                        <br />
                                    </div>
                                </div>
								</br>

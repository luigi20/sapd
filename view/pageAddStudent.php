...
<body>
    <form action="/sapd/student/addstudent" method="post">
		<?php
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-6">
                                    <label>
                                        Nome</label>
                                    <div class="controls">
										<input type="text" name ="sStudentName" autocomplete = "off" required class="form-control"/>
                                    </div>
                                </div>
                                    ...
                                    <div class="controls">
                                        <select name = "iClassId" autocomplete = "off" class="form-control">
											<?php
												...
												{
											?>		
											 <option value= '<?=  $aStudentsClass['idTurma'] ?>'><?=  $aStudentsClass['nomeTurma'] ?></option>
											<?php
												}
											?>
								 ...
								 <div class="control-group col-md-7">
                                    <label>
                                        Endereco</label>
                                    <div class="controls">
										<input type="text" name ="sStudentAddress" autocomplete = "off" required class="form-control"/>
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sStudentDateBirth" autocomplete = "off" class="form-control" maxlength= "10" pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$"  id= "dataNasc" onKeyUp="formataData(dataNasc,event)" required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    <label>
                                        Email</label>
                                    <div class="controls">
                                        <input type="email" name ="sStudentEmail" autocomplete = "off" class="form-control"  id= "studentEmail"  required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    <label>
                                        Celular</label>
                                    <div class="controls">
                                        <input type="text" name ="sStudentCell" autocomplete = "off" class="form-control" maxlength="14" id= "celular" onKeyUp="formataTelefone(celular,event)" required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="number" name ="sStudentDayMaturity" autocomplete = "off" class="form-control"   id= "dataVencimento" min="1" max="31" maxlength="2" />
                                        <br />
                                    </div>
                                </div>
                              <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <select name = "sStudentType"  class="form-control">
											<option selected value="Pagante">Pagante</option>
								...
								<div class="control-group col-md-3">
                                    ...
                                    <div class="controls">
                                       <select name = "sStudentMotivation"  class="form-control">
											...
											<option value="Faz Parte Do Meu Trabalho">Faz Parte do meu Trabalho</option>

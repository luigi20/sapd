...
<body>
    <form action="/sapd/lesson/updateindividuallesson" method="post">
		<?php
			$aIndividualLesson = IndividualLesson::findEditIndividualLesson();
			$aAllUserStudents = Student::allUserStudents();
		?>
     ...
     <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <a href="#"><strong><i class="glyphicon glyphicon-dashboard"></i>Aula Individual</strong></a>
                <hr />
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
							   <div class="control-group col-md-6">
                                    <label>
                                        Aluno</label>
                                    <div class="controls">
                                        <select name = "iStudent" autocomplete = "off" class="form-control">
											<?php
												foreach($aAllUserStudents as $aUserStudents)
												{
											?>		
											 <option  <?php echo $aUserStudents['idAluno'] == $aIndividualLesson['Aluno_idAluno'] ? 'selected':'';?> value="<?= $aUserStudents['idAluno']?>"> <?= $aUserStudents['nomeAluno']?></option>
											<?php
												}
											?>
							  ...
							  <div class="control-group col-md-3">
                                    <label>
                                        Tipo da Aula</label>
                                    <div class="controls">
                                        <select name = "sLessonType"  class="form-control">
											
											<option value="Individual" <?php echo $aIndividualLesson["tipoAulaIndividual"]=='Individual'?'selected':'';?> >Individual</option>
											<option value="Casal" <?php echo $aIndividualLesson["tipoAulaIndividual"]=='Casal'?'selected':'';?> >Casal</option>
                                ...
                                <div class="control-group col-md-3">
                                    <label>
                                        Data</label>
                                    <div class="controls">
										<input type="text" name ="sDateIndividualLesson" value="<?=$aIndividualLesson['dataAulaIndividual']?>" autocomplete = "off" maxlength= "10" required class="form-control" id="dateIndividualLesson" onKeyUp="formataData(dateIndividualLesson,event)"/> <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-3">
                                    ...
                                    <div class="controls">
                                         <input type="time"  autocomplete = "off" value="<?=$aIndividualLesson['horarioInicioAulaIndividual']?>"  name = "sStartTimeIndividualLesson" required class="form-control" />
                                ...
                                <div class="control-group col-md-3">
                                    <label>
                                        Horario Final</label>
                                    <div class="controls">
                                        <input type="time"  autocomplete = "off"  value="<?=$aIndividualLesson['horarioTerminoAulaIndividual']?>" name = "sFinalTimeIndividualLesson" required class="form-control" />
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                      <textarea class="ckeditor" rows="12" cols="61" required autocomplete = "off"  name ="sDescriptionIndividualLesson" > <?=$aIndividualLesson['descricaoAulaIndividual']?></textarea>

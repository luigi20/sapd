			...
			<tr>
				...
				?>	
							<tr>
								...
								<td align="center"> <a href="/sapd/event/editevent/<?= $aEvent['idEvento']?>">Editar  </a>
								<a  href="/sapd/event/removeevent/<?= $aEvent['idEvento'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					

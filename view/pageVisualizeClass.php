...
<body>
    <form action="" method="post">
		<?php
			$aAllClass = StudentsClass::allStudentsClassUser();
		?>
    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">TURMA</th>
			</tr>
			...
			<tr>
				<?php
				    ...
				    if(!empty($aAllClass))
				    {
						foreach ($aAllClass as $aClass) 
						{	
							$aLocal = Local::findLocal($aClass['Lugar_idLugar']);
				?>	
							<tr>
								<td align="center"> <?= $aClass['idTurma'];?> </td>
								<td align="center"> <?= $aLocal['nomeLugar'];?> </td>
								<td align="center"> <?= $aClass['nomeTurma'];?> </td>
								<td align="center"> <a href="/sapd/studentsclass/editclass/<?= $aClass['idTurma']?>">Editar  </a>
								<a  href="/sapd/studentsclass/removeclass/<?= $aClass['idTurma'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					

...
<body>
    <form action="" method="post">
		<?php
			$aAllStudent = Student::allUserStudents();
		?>
    ...
    <!-- Main -->
     <div class="container-fluid">
        <div class="row">
			...
			<tr>
				<th colspan="10" align="center">ALUNO</th>
			</tr>
			...
			<tr>
				<?php
				    ...
				    if(!empty($aAllStudent))
				    {
						foreach ($aAllStudent as $aStudent) 
						{	
							$aClass = StudentsClass::findClass($aStudent['Turma_idTurma']);
				?>	
							<tr>
								<td align="center"> <?= $aStudent['idAluno'];?> </td>
								<td align="center"> <?= $aClass['nomeTurma'];?> </td>
								<td align="center"> <?= $aStudent['nomeAluno'];?> </td>
								<td align="center"> <?= $aStudent['enderecoAluno'];?> </td>
								<td align="center"> <?= $aStudent['celularAluno'];?> </td>
								<td align="center"> <?= $aStudent['emailAluno'];?> </td>
								<td align="center"> <?= $aStudent['dataNascAluno'];?> </td>
								<td align="center"> <?= $aStudent['nivelAluno'];?> </td>
								<td align="center"> <?= $aStudent['tipoAluno'];?> </td>
								<td align="center"> <a href="/sapd/student/editstudent/<?= $aStudent['idAluno']?>">Editar  </a>
								<a  href="/sapd/student/removestudent/<?= $aStudent['idAluno'] ?> ">Deletar</a> </td>
							</tr>
				<?php
						}
					}					

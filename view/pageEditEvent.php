...
<body>
    <form action="/sapd/event/updateevent" method="post">
		<?php
			$aEvent	 = Event::findEditEvent(); 
		?>
                        ...
                        <div class="panel panel-default">
                           ...
                           <div class="panel-body">
                                <div class="control-group col-md-7">
                                    ...
                                    <div class="controls">
										 <input type="text" name ="sEventAddress" autocomplete = "off" class="form-control" value="<?=$aEvent['enderecoEvento']?>"  required/>
                                    </div>
                                </div>
                                 <div class="control-group col-md-6">
                                    <label>
                                        Nome </label>
                                    <div class="controls">
                                        <input type="text" name ="sEventName" autocomplete = "off" class="form-control" value="<?=$aEvent['nomeEvento']?>" required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="fIncomeCost" autocomplete = "off" class="form-control" value="<?=str_replace('.',',',$aEvent['rendaEvento'])?>"  id= "income"    onKeyUp="formataValor(income,event)" onBlur = "calcularEvento();"  required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="fEventCost" autocomplete = "off" class="form-control"  id= "cost"  value="<?=str_replace('.',',',$aEvent['custoEvento'])?>"   onKeyUp="formataValor(cost,event)"  onBlur = "calcularEvento();"   required/>
                                        <br />
                                    </div>
                                </div>
								<div id = "resultado"></div>
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="fProfitCost" autocomplete = "off" readonly class="form-control" value="<?=str_replace('.',',',$aEvent['lucroEvento'])?>"  id= "profit" onKeyUp="formataValor(profit,event)"     required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <textarea class="ckeditor" rows="12" cols="61" id = "a"required autocomplete = "off"  name ="sDescriptionEvent"  ><?=$aEvent['descricaoEvento']?> </textarea>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                         <textarea class="ckeditor" rows="12" cols="61"  autocomplete = "off"  name ="sEventGuestList" > <?=$aEvent['listaConvidadosEvento']?> </textarea>
                                        <br />
                                    </div>
                                </div>

...
<body>
    <form action="/sapd/payment/addpayment" method="post">
		<?php
                            ...
                            <div class="panel-body">
                                <div class="control-group col-md-7">
                                    ...
                                    <div class="controls">
										<select name = "iStudentId"  class="form-control">
											<?php
												...
												{
											?>		
											 <option value= '<?=  $oUserStudents['idAluno'] ?>'><?=  $oUserStudents['nomeAluno'] ?></option>
											<?php
												}
											?>
										</select>
                                 ...
                                 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sPaymentDay" autocomplete = "off" class="form-control" maxlength="10" id= "paymentDay" onKeyUp="formataData(paymentDay,event)" required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="month" name ="iPaymentMonth" autocomplete = "off" class="form-control" maxlength="14" min="2017-01-01" max="2099-12-31" id= "paymentMonth"  required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="sPaymentLocal" autocomplete = "off" class="form-control"   required/>
                                        <br />
                                    </div>
                                </div>
								 ...
								 <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <input type="text" name ="iPaymentValue" autocomplete = "off" class="form-control" maxlength="4" id= "paymentValue" onKeyUp="formataInteiro(paymentValue,event)" required/>
                                        <br />
                                    </div>
                                </div>
								</br>
